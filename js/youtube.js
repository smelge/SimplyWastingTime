(function() {
  ...
  var OAUTH2_CLIENT_ID = '396006892605-7ujdc92fn47jujjch6jpg747vmdsvbob.apps.googleusercontent.com';
  var OAUTH2_SCOPES = [
  ...
  function getVideoMetadata(videoIds) {
    ...
    request.execute(function(response) {
      if ('error' in response) {
        ...
        // Get the jQuery wrapper for #yt-video-list once outside the loop.
        var videoList = $('#yt-video-list');
