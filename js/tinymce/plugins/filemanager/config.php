...
$base_url="http://www.simplywastingtime.com"; //url base of site if you want only relative url leave empty
$upload_dir = './assets/uploaded/'; // path from base_url to upload base dir
$current_path = '../../../../assets/uploaded/'; // relative path from filemanager folder to upload files folder
