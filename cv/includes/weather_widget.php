<?php //Weather Widget
	$metoffice_api_key = 'eeabc323-20e2-4884-8458-f09aa9462770';

	$json_array = json_decode(file_get_contents("http://datapoint.metoffice.gov.uk/public/data/val/wxfcs/all/json/".$centre['weather']."?res=3hourly&key=".$metoffice_api_key), true);
	$json_daily = json_decode(file_get_contents("http://datapoint.metoffice.gov.uk/public/data/val/wxfcs/all/json/".$centre['weather']."?res=daily&key=".$metoffice_api_key), true);
